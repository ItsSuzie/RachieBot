...
def initRachieBot():
    ...
    owo_handler = CommandHandler("owoify", owo)
...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hello world! I'm RachieBot! Your premire shitposter bot by Rachie!")
...
# PrInTs ThE TeXt AfTeR /WeIrD As "wEiRd CaSe"
